...
public class ConversationActivityCamp extends AppCompatActivity implements AttachmentSender.UploadListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_conversation_camp);
...
//            }
//        });
        FileAttachmentSender fileAttachmentSender = new FileAttachmentSender(this, channel, "File", R.drawable.ic_document_chat);
        fileAttachmentSender.setUploadListener(this);
        GalleryAttachmentSender galleryAttachmentSender = new GalleryAttachmentSender(this, channel, "Gallery", R.drawable.ic_menu_gallery);
        galleryAttachmentSender.setUploadListener(this);
        CameraAttachmentSender cameraAttachmentSender = new CameraAttachmentSender(this, channel, "Camera", R.drawable.ic_menu_camera);
    ...
    protected void onResume() {
        ...
        if(!TextUtils.isEmpty(channelId)) {
            GoGroup.getInstance().setGroupIdCamp(channelId);
        }
    }
    ...
    protected void onPause() {
        ...
        GoGroup.getInstance().setGroupIdCamp("");
        super.onPause();
    }
