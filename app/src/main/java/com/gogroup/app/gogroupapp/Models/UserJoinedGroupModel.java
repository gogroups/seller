...
public class UserJoinedGroupModel {
    ...
    public UserJoinedGroupModel(String group_name, String group_members, String group_pic, String start_date, String end_date, String status) {
        this.group_name = group_name;
