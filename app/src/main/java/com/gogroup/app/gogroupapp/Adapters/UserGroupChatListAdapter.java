...
import com.gogroup.app.gogroupapp.User.JoinedGroupChat;
...
public class UserGroupChatListAdapter extends BaseAdapter {
    private Context mContext;
    private ArrayList<UserChatModel> data = new ArrayList<UserChatModel>();

    public UserGroupChatListAdapter(Context c, ArrayList<UserChatModel> mData ) {
        mContext = c;
        this.data = mData;
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        // TODO Auto-generated method stub
        UserGroupChatListAdapter.ViewHolder holder = null;
        UserChatModel model = data.get(position);
        LayoutInflater inflater = (LayoutInflater) mContext
                .getSystemService(Context.LAYOUT_INFLATER_SERVICE);

        if (convertView == null) {
            holder = new UserGroupChatListAdapter.ViewHolder();
            convertView = inflater.inflate(R.layout.user_group_chat_list_item,null);
            ...
            holder = (UserGroupChatListAdapter.ViewHolder) convertView.getTag();
        ...
        holder.messageIcon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent startPersonalChatIntent = new Intent(mContext, JoinedGroupChat.class);
